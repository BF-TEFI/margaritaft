export const state = () => ({
  ...
  faq: [
    {
      q: '1. - Я не модель, и вообще почти никогда не фотографировалась. У меня получится?',
    ...
    {
      q: '7. - Если я хочу другие локации, как быть?',
      a: 'Мы проводим фотосессии даже на острове Коче! Так что всё обсуждаемо.'
    },
    {
      q: '8. - Когда ждать фотоснимки, и сколько их будет?',
    ...
    {
      q: '9. - Отправляете ли вы исходники?',
